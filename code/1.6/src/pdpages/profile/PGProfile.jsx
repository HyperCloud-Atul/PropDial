...
export default function PGProfile() {
  ...
  const handleFileChange = async (e) => {
    ...
    if (compressedImage) {
      const uploadPath = `userThumbnails/${user.phoneNumber}/${thumbnailName}`;
