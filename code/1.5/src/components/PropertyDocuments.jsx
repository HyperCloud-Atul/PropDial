...
const PropertyDocuments = () => {
  ...
  const handleFileChange = (event, docId) => {
    ...
    if (file) {
      ...
      if (file.size > MAX_FILE_SIZE_BYTES) {
        alert(
          `File size exceeds the maximum limit of ${MAX_FILE_SIZE_MB} MB. Please upload a smaller file.`
        );
  ...
  const docTypes = {
    "Property Document": [
      ...
      {
        id: "bba",
        value: "Builder Buyer Agreement (BBA)",
        label: "Builder Buyer Agreement (BBA)",
      },
      {
        id: "allotmentletter",
      ...
      {
        id: "offerofpossession",
        value: "Offer of Possession",
        label: "Offer of Possession",
      },
      {
        id: "oc",
        value: "Occupation Certificate (OC)",
        label: "Occupation Certificate (OC)",
      },
      {
        id: "agreementtosale",
        value: "Agreement to Sale",
                ...
                <Tabs>
                  ...
                  <TabPanel>
                    ...
                    {viewMode === "table_view" &&
                      filteredPropDocLength !== 0 && (
                        <>
                          {filteredPropertyDocuments && (
                            <PropertyDocumentTableOnly
                              filterDoc={filteredPropertyDocuments}
                  ...
                  <TabPanel>
                    ...
                    {viewMode === "table_view" &&
                      filteredMaintainanceDocLength !== 0 && (
                        <>
                          {filteredPropertyMaintainanceDocuments && (
                            <PropertyDocumentTable
                              filterDoc={filteredPropertyMaintainanceDocuments}
                              dbUserState={dbUserState}
                            />
                          )}
                        </>
                  ...
                  <TabPanel>
                    ...
                    {viewMode === "card_view" && (
                      <div className="blog_sect">
                        <div className="row">
                          {filteredPropertyUtilityDocuments.map(
                            (doc, index) => (
                              <div className="col-xl-4 col-md-6" key={index}>
                                <div
                                  className="item card-container relative"
                    ...
                    {viewMode === "table_view" &&
                      filteredUtilityDocLength !== 0 && (
                        <>
                          {filteredPropertyUtilityDocuments && (
                            <PropertyDocumentTable
                              filterDoc={filteredPropertyUtilityDocuments}
                              dbUserState={dbUserState}
                            />
                          )}
                        </>
                  ...
                  <TabPanel>
                    ...
                    {viewMode === "table_view" &&
                      filteredPropertyTaxLength !== 0 && (
                        <>
                          {filteredPropertyPropertyTax && (
                            <PropertyDocumentTable
                              filterDoc={filteredPropertyPropertyTax}
                              dbUserState={dbUserState}
                            />
                          )}
                        </>
