          ...
          <div className="report">
            ...
            <div className="detail_card">
              ...
              <div className="dc_single">
                ...
                <h6>naman@hyperclouddigital.com</h6>
              </div>
            </div>
                  ...
                  <div className="issues">
                    <div className="top">
                      <div className="i_single">
                        ...
                        <p>{room.seepageRemark ? room.seepageRemark : ""}</p>
...
<p>Genral remark area</p>
        ...
        {inspectionDoc && inspectionDoc.inspectionType}
        </div> */}
      </div>
    </div>
  );
