        ...
        <div className="property_card_single mobile_full_card overflow_unset onboarded_card">
          <div className="more_detail_card_inner">
            <div className="p_info">
              ...
              <div className="p_info_single">
                <div className="pd_icon">
                  <img src="/assets/img/edicon/calendar2.png" alt="propdial" />
                </div>
                <div className="pis_content">
            ...
            <div className="more_detail_card_inner">
              ...
              {!isEdEditing && (
                <div className="p_info">
                  ...
                  <div className="p_info_single">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/id.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Employee ID</h6>
                      <h5>
            ...
            <div className="more_detail_card_inner">
              ...
              {!isBankDetailEditing && (
                <div className="p_info for_ref">
                  ...
                  <div className="p_info_single">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/bank.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Bank Name</h6>
                      <h5>
                  ...
                  <div className="p_info_single ">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/branch.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Branch Name</h6>
                      <h5>
            ...
            <div className="more_detail_card_inner">
              ...
              {!isRef1Editing && (
                <div className="p_info for_ref">
                  <div className="p_info_single">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/user.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Name</h6>
                      <h5>
                  ...
                  <div className="p_info_single">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/mail.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Email</h6>
                      <h5>
                  ...
                  <div className="p_info_single address">
                    <div className="pd_icon">
                      <img src="/assets/img/edicon/pin.png" alt="propdial" />
                    </div>
                    <div className="pis_content">
                      <h6>Address</h6>
                      <h5>
                  ...
                  <div>
                    {userProfileDoc && userProfileDoc.aadhaarcardUrl ? (
                      userProfileDoc.aadhaarcardType === "image" ? (
                        <img src={userProfileDoc.aadhaarcardUrl} alt="propdial" />
                      ) : (
                        <iframe
                          title="PDF Viewer"
                      ...
                      <img src="/assets/img/image_small_placeholder.png" alt="propdial" />
                    )}
                  </div>
                )}
                {docType === "PAN Card" && (
                  <div>
                    {userProfileDoc && userProfileDoc.pancardUrl ? (
                      userProfileDoc.pancardType === "image" ? (
                        <img src={userProfileDoc.pancardUrl} alt="propdial" />
                      ) : (
                        <iframe
                          title="PDF Viewer"
                  ...
                  <div>
                    {userProfileDoc && userProfileDoc.drivinglicenceUrl ? (
                      userProfileDoc.drivinglicenceType === "image" ? (
                        <img src={userProfileDoc.drivinglicenceUrl} alt="propdial" />
                      ) : (
                        <iframe
                          title="PDF Viewer"
