...
const BlogEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedData = {
      title,
      subTitle, // Include subTitle in updated data
      altText,
      metaTitle,
      metaDescription,
      slug,
  ...
  return (
    <div className="top_header_pg pg_bg" style={{ padding: "20px", background: "#f7f9fc" }}>
      <div className="page_spacing pg_min_height container" style={{ marginTop: "40px" }}>
        <h2 className="m22 text_blue text-center mb-4">Add Blog</h2>
                  ...
                  <div className="add_and_images">
                    {image && (
                      <div className="uploaded_images relative">
                        <img src={image.url} alt={image.name} style={{ width: "100%", borderRadius: "4px", marginBottom: "10px" }} />
