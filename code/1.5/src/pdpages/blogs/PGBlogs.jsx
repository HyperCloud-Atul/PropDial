                        ...
                        <div className='blog_inner relative'>
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog1.jpg" />
                                    </div>
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog2.webp" />
                                    </div>
                                    <div className="card-body">
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog2.webp" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog3.webp" />
                                    </div>
                                    <div className="card-body">
                                        {/* <span className="card-badge">Agencies</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source3.png" alt="propdial" />
                                        </div>
                                        <h3>
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog3.webp" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog5.jpeg" />
                                    </div>
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source4.png" alt="propdial" />
                                        </div>
                                        <h3>
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog5.jpeg" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    ...
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source5.png" alt="propdial" />
                                        </div>
                                        <h3>
                                ...
                                <div className="item card-container">
                                    ...
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source6.png" alt="propdial" />
                                        </div>
                                        <h3>
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog6.avif" />
                                    </div>
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog6.avif" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog7.jpg" />
                                    </div>
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source7.png" alt="propdial" />
                                        </div>
                                        <h3>
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog7.jpg" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    <div className="card-image">
                                        <img src="./assets/img/home/blog8.webp" />
                                    </div>
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog8.webp" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
                                ...
                                <div className="item card-container">
                                    ...
                                    <div className="card-body">
                                        {/* <span className="card-badge">Propdial</span> */}
                                        <div className="blog_source">
                                            <img src="./assets/img/home/blog_source8.png" alt="propdial" />
                                        </div>
                                        <h3>
                                        ...
                                        <div className="card-author">
                                            <img src="./assets/img/home/blog8.png" alt="author avatar" />
                                            <div className="author-info">
                                                {/* <p className="author-name">John Doe</p>
                                                <p className="post-timestamp">2h ago</p> */}
