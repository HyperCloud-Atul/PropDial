...
export default function PGOwnerDashboardOld() {
      ...
      <div className="container">
        <div className="row no-gutters">
              ...
              >
                ...
                <div className="address-text">
                  ...
                  >
                    ...
                    <h5
                      style={{ margin: "0", fontSize: "0.8rem", color: "#888" }}
                    >
                      0
                    </h5>
                  </div>
          ...
          <div className="col-lg-3 col-6" style={{ padding: "2%" }}>
            <h5 style={{ paddingLeft: "2%", fontWeight: "bolder" }}>
              HOME SERVICES
            </h5>
            <br />
            <div className="addon-service">
              <div className="">
                <center>
                  <img src="./assets/img/1.png" alt="propdial" />
            ...
            <div className="addon-service">
              <div className="">
                <center>
                  <img src="./assets/img/2.png" alt="propdial" />
          ...
          <div className="col-lg-3 col-6" style={{ padding: "2%" }}>
            <h5 style={{ visibility: "hidden" }}>Home SERVICES</h5>
            <br />

            <div className="addon-service">
              <div className="">
                <center>
                  <img src="./assets/img/3.png" alt="propdial" />
            ...
            <div className="addon-service">
              <div className="">
                <center>
                  <img src="./assets/img/4.png" alt="propdial" />
