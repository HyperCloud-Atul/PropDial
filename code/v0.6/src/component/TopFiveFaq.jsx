...
const TopFiveFaq = () => {
  ...
  const className = `faq_single_page sect_padding ${
    shouldHide ? "" : "d_none"
  }`;
  // faq display none Array
  return (
    <section className="sect_faq">
              ...
              <div className="fsp_right">
                ...
                <div class="accordion" id="a1accordion_section2">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        Propdial is a Property Management and Maintenance
                        company designed to serve home owners, and help them to
                        manage their property with no hassle.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        PMS stands Property Management Services that we provide
                        to our customers, and includes following services at a
                        high level.
                        <ol>
                          <li>
                            Renting/Leasing - we will find the tenant if you
                            want to let out
                          </li>
                          <li>
                          ...
                          <li>
                            Maintenance as needed (painting, plumbing,
                            electrical work etc.)
                          </li>
                        </ol>
                      </div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        PMS is a legal document that helps us to work on your
                        behalf when managing your property. We visit your
                        property to review, work with your tenant for rent
                        collection, get repairs done after your approval etc.
                        and this document helps us to take care of all these
                        things as an authorised service provider.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="a1headingfour">
                      ...
                      >
                        I don't think I need full PMS services. I just want to
                    ...
                    >
                      <div class="accordion-body">
                        We only provide renting services to those properties
                        which are coming to us for Property Management Services
                        and properties who are managed by only Prodial.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        We have a big broker network who work for us on payment.
                        We pass this brokerage to the brokers to have them work
                        on your property on high priority. Propdial doesn't keep
