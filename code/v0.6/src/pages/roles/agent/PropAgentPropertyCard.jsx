...
const PropAgentPropertyCard = ({ property }) => {
  ...
  const setRentedOut = async (propertyid) => {
    let purpose = "Rent";
    if (document.getElementById("switch_Rentedout").checked === true) {
      console.log("switch_Rentedout true");
      purpose = "RENT";
    }
    if (document.getElementById("switch_Rentedout").checked === false) {
      console.log("switch_Rentedout false");
      purpose = "RENTED OUT";
    }
  ...
  const setSoldOut = async (propertyid) => { };
