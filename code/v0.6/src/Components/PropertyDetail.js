            ...
            <div className="pcs_other_info propagent_details">
              <div className="item pcp_single">
                ...
                <div className="contacts">
                  <a href={"tel:" + property.createdBy.phoneNumber} className="contacts_single">
                    <div className="icon">
                  ...
                  <a href={"https://wa.me/" + property.createdBy.phoneNumber} className="contacts_single">
                    <div className="icon">
                  ...
                  <a href={"mailto:" + property.createdBy.emailID} className="contacts_single">
                    <div className="icon">
                      <span className="material-symbols-outlined">
                        mail
                      </span>
