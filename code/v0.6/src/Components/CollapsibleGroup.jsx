            ...
            <div className="fsp_right">
              ...
              <div className="accordion" id="a1accordion_section2">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      PropAgent is a Property Management and Maintenance company designed to serve home owners, and help them to manage their property with no hassle.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      We have a big broker network who work for us on payment. We pass this brokerage to the brokers to have them work on your property on high priority. PropAgent doesn’t keep any brokerage amount.
                    </div>
                  </div>
                </div>
              </div>
