      ...
      <section className="our_team sect_padding">
        <div className="container">
          <div className="section_title">
            <div className="section_title_effect">OUR TEAM</div>
              ...
              <div className="flip-card" tabIndex="0">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back"
                    ...
                    <h3>A seasoned Entrepreneur, thought leader and alumnus of IIT Kanpur and IIT Kharagpur. Prior to PropAgent, he was part of a Global IT consulting firm for close to two decades, working at various leadership roles, responsible for building and growing multiple business verticals</h3>
                  </div>
                </div>
              </div>
              <div className="about_tm">
