...
export default function MasterStateList() {
    ...
    const { updateDocument, response: responseUpdateDocument } = useFirestore('m_states')
    ...
    const filteredData = masterState ? masterState.filter(document => {
                            ...
                            <div className="profile-card-div" style={{ position: 'relative' }}>
                                <div className="address-div" style={{ paddingBottom: '5px' }}>
                                    ...
                                    <div className="address-text">
                                        <div onClick={() => handleEditCard(data.id, data.country, data.state)}
                                            style={{
                                                width: '80%',
                                                height: '170%',
                                                textAlign: 'left',
                                            ...
                                            <h5 style={{ margin: '0', transform: 'translateY(5px)' }}>{data.state}</h5>
                                            <small style={{ margin: '0', transform: 'translateY(5px)' }}>{data.country}</small>
                                        </div>
