...
export default function PropertyLayoutComponent(props) {
    ...
    const { document: propertyLayoutDoc, error: propertyLayoutDocError } = useDocument(
        "propertylayouts",
        layoutid
    );
    ...
    const { addDocument: addPropertyLayoutDocument, updateDocument: updatePropertyLayoutDocument, deleteDocument: deletePropertyLayoutDocument, error: propertyLayoutDocumentError } = useFirestore("propertylayouts");
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-sm-3">
                        <div className="theme_btn btn_fill text-center" onClick={handlePropertyLayout}>
                            {(props.layoutid === "1234" || props.layoutid === null) ? "Add" : "Edit"}
                        </div>
                    </div>
                </div>
            </div>
