        ...
        {propertyDocument && propertyDocument.unitNumber ? (
          inspectionDoc && (
            <div className="report" ref={reportRef} id="print-section">
              {/* Generate PDF Button */}
                <button onClick={handleDownloadClick} className="theme_btn btn_border no_icon w-100 mb-3">
                  Download PDF
                </button>
