...
export default function Navbar() {
  ...
  const isInspectionReportPage = location.pathname.startsWith(
    "/inspection-report/"
  );
  const showHome = () => {
    navigate("/");
  ...
  const showSecondPage = () => {
    if (!user) {
      ...
      else if (user.role === "frontdesk") navigate("/properties");
  ...
  const showThirdPage = () => {
    if (!user) {
      ...
      else if (user.role === "hr") navigate("/userlist");
      else if (user.role === "frontdesk") navigate("/blogs");
      else navigate("/my-property");
    }
  };
  ...
  const unreadNotifications = notifications?.filter(
    (notification) =>
      (notification.viewedBy || []).includes(user && user.uid) === false
  );
          ...
          <ul>
            ...
            <li className="main_menus">
              ...
              >
                ...
                {/* </span> */}
                {/* <span>
                  <img src="/assets/material-icons/home.svg" alt="propdial"></img>
                </span> */}
                {firstMenu}
              </div>
              ...
              >
                ...
                {/* </span> */}
                {/* <span>
                  <img src="/assets/material-icons/dashboard.svg" alt="propdial"></img>
                </span> */}
              ...
              >
                ...
                {/* </span> */}
                {/* <span>
                  <img src="/assets/material-icons/real_estate_agent.svg" alt="propdial"></img>
                </span> */}
              ...
              <Link to="/more-menu">
                <div className={moreDesktopActiveClass}>
                  ...
                  {/* <span>
                    <img src="/assets/material-icons/more.svg" alt="propdial"></img>
                  </span> */}
                  More
                </div>
              </Link>
              {user ? (
                ...
                >
                  ...
                  <div className="user_img">
                    {user.photoURL === "" ? (
                      ...
                      <img src={user.photoURL} alt="propdial" />
                    )}
                  </div>
                </Link>
              ) : (
                <Link to="/login">
                  ...
                  >
                    ...
                    {/* <span>
                      <img src="/assets/material-icons/login.svg" alt="propdial"></img>
                    </span> */}
                    Login
                  </div>
                </Link>
            ...
            <li className="menu_social_media">
              {/* <Link to="/ticketdetail">
                <img src="./assets/img/home/ticketicon_navbar.png" alt="propdial"
                  className="pointer" />
              </Link> */}
