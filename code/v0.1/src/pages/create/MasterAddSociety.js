...
export default function MasterAddSociety() {
            ...
            <div style={{ overflow: 'hidden' }}>
                ...
                <form onSubmit={handleSubmit} className="auth-form" style={{ maxWidth: '350px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <button className="btn">Add Society</button>
                                ...
                                <div className="address-div" style={{ paddingBottom: '5px' }}>
                                    ...
                                    <div className="address-text">
                                        <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column' }}>
                                            <h5 style={{ margin: '0' }}>{data.society}  </h5>
                                            <small style={{ margin: '0' }}>{data.locality}, {data.city}, {data.state}, {data.country}</small>
                                        </div>
                                        <div className="">
