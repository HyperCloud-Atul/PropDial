...
import PGTenantDashboard from "../roles/tenant/PGTenantDashboard";
      ...
      <div>
        {user &&
          (user.role.toLowerCase() === "executive" ||
            user.role.toLowerCase() === "manager") && <PGManagerDashboard />}
      </div>
      <div>
        {user &&
          (user.role.toLowerCase() === "admin" ||
            user.role === "superAdmin") && <PGAdminDashboard />}
      </div>
    </>
  );
};
