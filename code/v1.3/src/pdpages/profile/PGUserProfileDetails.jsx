...
export default function PGUserProfileDetails() {
  ...
  return (
   ...
   <div className="container">
          ...
          <div className="row no-gutters">
            ...
            <div className="col-lg-7 col-md-7 col-sm-12">
              <div className="profile-card-content">
                ...
                <div>
                  <h3>
                    {userProfileDoc && camelCase(userProfileDoc.rolePropDial)}
                  </h3>
                </div>
                <div>
                  ...
                  <div
                    style={{ padding: "0" }}
                    className="residentail_commercial"
                  >
                    <label className="on">
                ...
                >
                  <small style={{ fontSize: "1.2rem", color: "#888" }}>
                    Last Logged-in
                  </small>
                  <h2
                    style={{
        ...
        <br />
        {userProfileDoc && userProfileDoc.whoAmI === "employee" && (
          <div className="profile-card">
            ...
            <div className="row no-gutters" style={{ padding: "0 10px" }}>
              ...
              >
                <div
                  className="employee-details-static"
                ...
                >
                  <div>
                    ...
                    <h5>
                      Atul Tripathi / 9822752885 / atulmani@gmail.com /
                      super_admin
                    </h5>
                  </div>
                  <span className="material-symbols-outlined">edit</span>
                ...
                <div className="employee-details-static">
                  <div>
                    ...
                    >
                      ...
                      <option
                        defaultValue={
                          userProfileDoc && userProfileDoc.department === "IT"
                            ? true
                            : false
                        }
                      >
                      ...
                      <option
                        defaultValue={
                          userProfileDoc && userProfileDoc.department === "HR"
                            ? true
                            : false
                        }
                      >
              ...
              >
                <div
                  className="employee-details-static"
                  style={{ borderBottom: "none", paddingBottom: "2px" }}
                >
                  <div>
                    <small>
        ...
        <div className="profile-card">
          ...
          <div className="access-management-tabs">
            <div
              onClick={accessManagementSelectCountry}
              className={
                selectedOption === "Country"
                  ? "access-management-tabs-inner active"
                  : "access-management-tabs-inner"
              }
            ...
            <div
              onClick={accessManagementSelectState}
              className={
            ...
            <div
              ...
              className="access-management-tabs-indicator"
            ></div>
          </div>

          <div style={{ padding: "8px" }} />
          <div className="row no-gutters" style={{ padding: "0 10px" }}>
            {(selectedOption === "Country" || selectedOption === "State") && (
              <div
                className="col-lg-6 col-md-6 col-sm-12"
                style={{ padding: "0" }}
              >
        ...
        {userProfileDoc && userProfileDoc.reference1 && (
          <div className="profile-card">
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              {!isEditReferenceOne ? (
                <span
                  onClick={editReferenceOne}
                  className="material-symbols-outlined reference-edit"
                >
                  edit
                </span>
              ) : (
                <span
                  onClick={saveReferenceOne}
                  className="material-symbols-outlined reference-edit"
                >
                  done
                </span>
              ...
              >
                <div className="employee-details-static">
                  <div style={{ width: "100%" }}>
                    ...
                    <br />
                    <input
                      readOnly={isEditReferenceOne ? false : true}
                      placeholder="Enter Name"
                      type="text"
                      value={userProfileDoc.reference1.name}
                    ></input>
                  </div>
                </div>
              </div>
                ...
                <div className="employee-details-static">
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      ...
                      type="email"
                      value={userProfileDoc.reference1.email}
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      ...
                      type="number"
                      value={userProfileDoc.reference1.mobile}
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  <div style={{ width: "100%" }}>
                    ...
                    <textarea
                      ...
                      id=""
                      value={userProfileDoc.reference1.address}
                    ></textarea>
                  </div>
                </div>
              </div>
        ...
        <br />
        {/* Reference 2 */}
        {userProfileDoc && userProfileDoc.reference2 && (
          <div className="profile-card">
            <div
              style={{
                display: "flex",
              ...
              >
                <div className="employee-details-static">
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      placeholder="Enter Name"
                      readOnly={isEditReferenceTwo ? false : true}
                      type="text"
                      value={userProfileDoc.reference2.name}
                    ></input>
                  </div>
                </div>
              </div>
                ...
                <div className="employee-details-static">
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      ...
                      readOnly={isEditReferenceTwo ? false : true}
                      type="email"
                      value={userProfileDoc.reference2.email}
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      ...
                      readOnly={isEditReferenceTwo ? false : true}
                      type="number"
                      value={userProfileDoc.reference2.mobile}
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  <div style={{ width: "100%" }}>
                    ...
                    <textarea
                      ...
                      placeholder="Enter Address"
                      id=""
                      value={userProfileDoc.reference2.address}
                    ></textarea>
                  </div>
                </div>
              </div>
