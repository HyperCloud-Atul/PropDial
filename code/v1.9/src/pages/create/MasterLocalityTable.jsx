...
const MasterLocalityTable = ({ filterData, handleEditCard }) => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value, row }) => (
          <div
            onClick={() =>
              handleEditCard(row.original.id, row.original.country, row.original.state, row.original.city, row.original.locality)
            }
