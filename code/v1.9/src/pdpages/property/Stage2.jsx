...
const Stage2 = (props) => {
    ...
    if (propertyDocument) {
      ...
      setPropertyDetails({
        ...
        PantryCafeteria: propertyDocument.pantryCafeteria
          ...
          : "",
        Washrooms: propertyDocument.washrooms ? propertyDocument.washrooms : "",
        ...
        EVChargingPointType: propertyDocument.evChargingPointType
          ...
          : "",
        GatedArea: propertyDocument.gatedArea ? propertyDocument.gatedArea : "",
  ...
  function decrementInput(input) {
    ...
    if (input === "floorNoInput" && inputValue > -1) {
      ...
      (input === "numberOfFloorsInput" ||
        input === "numberOfFlatsOnFloorInput") &&
      inputValue > 1
    ) {
      ...
      if (input === "numberOfFloorsInput") {
        let currentFloor;
        if (
          propertyDetails.FloorNo === "LB" ||
          propertyDetails.FloorNo === "UB" ||
  ...
  const handleNextSubmit = async (e) => {
    ...
    if (
      ...
      propertyDetails.OwnerShip === undefined ||
      propertyDetails.OwnerShip === null
    ) {
      errorFlag = true;
    }
    ...
    if (propertyDetails && propertyDetails.Category === "Commercial") {
      if (
        ...
        propertyDetails.CarpetArea === "0" //Carpet are is mandatory
      ) {
      ...
      if (
        (propertyDetails.SuperArea === "" &&
          propertyDetails.CarpetArea === "") ||
        (propertyDetails.SuperArea === "0" &&
          propertyDetails.CarpetArea === "0")
      ) {
    ...
    if (propertyDetails && propertyDetails.Category === "Plot") {
      ...
      if (
        propertyDetails.RoadWidth === "" ||
        propertyDetails.RoadWidth === "0"
      ) {
        // if (errorMsg === "Please select ")
    ...
    const property = {
      ...
      pantryCafeteria: propertyDetails.PantryCafeteria
        ...
        : "",
      washrooms: propertyDetails.Washrooms ? propertyDetails.Washrooms : "",
      ...
      gatedArea: propertyDetails.GatedArea ? propertyDetails.GatedArea : "",
        ...
        <div className="row row_gap form_full">
          ...
          <div className="col-xl-4 col-lg-6">
            <div className="form_field st-2 label_top">
              ...
              propertyDetails.OwnerShip === undefined ||
              propertyDetails.OwnerShip === null ? (
                <div className="field_error">Please select Ownership</div>
              ) : (
                ""
              )}
            </div>
          ...
          <div className="col-xl-4 col-lg-6 col-md-4">
            <div className="form_field label_top">
              ...
              propertyDetails.PropertyType === "Select Property Type" ? (
                <div className="field_error">Please select Property Type</div>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="col-md-4">
              <div className="form_field label_top">
                ...
                propertyDetails.Bhk === "Select BHK" ? (
                  <div className="field_error">Please select BHK</div>
                ) : (
                  ""
                )}
              </div>
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "IT Park"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Office" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] ===
                            "Commercial Building"
                            ? "radiochecked"
                            : ""
                        }`}
                  ...
                  {propertyDetails.PropertyType === "Office" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Basement"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Office" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Mall"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Retail" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Shop"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Retail" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Showroom"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Storage" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Warehouse"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Storage" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Cold Storage"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Land" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Farm House"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Industry" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Factory"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Industry" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Building"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Industry" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Shed"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Hospitality" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Guest House"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Hospitality" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Hotel"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Hospitality" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Resort"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Hospitality" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Banquet-Hall"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.PropertyType === "Other" && (
                    ...
                    >
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.AdditionalRooms[0] === "Other"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  >
                    <div className="radio_group_single">
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.Readiness === "Ready to Move-In"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                    ...
                    <div className="radio_group_single">
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.Readiness === "Under Construction"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
            ...
            propertyDetails.PropertyType !== "Other" && (
              <div className="col-md-4">
                <div className="form_field st-2 label_top">
                  ...
                  >
                    <div className="radio_group_single">
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.Furnishing === "Fully-Furnished"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                    ...
                    <div className="radio_group_single">
                      <div
                        className={`custom_radio_button ${
                          propertyDetails &&
                          propertyDetails.Furnishing === "Semi-Furnished"
                            ? "radiochecked"
                            : ""
                        }`}
                      >
                  ...
                  {propertyDetails.Furnishing === "" ? (
                    <div className="field_error">Please select Furnishing</div>
                  ) : (
                    ""
                  )}
                </div>
              ...
              <div className="form_field label_top">
                ...
                <div className="increase_input_parent">
                  <div className="plus_minus_input_wrapper">
                    {propertyDetails.Category === "Commercial" ? (
                      <span className="pmi_label">Rooms</span>
                    ) : (
                  ...
                  <div className="plus_minus_input_wrapper">
                    {propertyDetails.Category === "Commercial" ? (
                      <span className="pmi_label">Toilets</span>
                    ) : (
                    ...
                    <div className="plus_minus_input_wrapper">
                      ...
                      <div className="plus_minus_input">
                        ...
                        <input
                          ...
                          disabled
                          value={
                            propertyDetails && propertyDetails.NumberOfBalcony
                          }
                        />
                        <div
                          className="right-plus-button pmbutton"
                    ...
                    <div className="plus_minus_input_wrapper">
                      ...
                      <div className="plus_minus_input">
                        ...
                        <input
                          ...
                          disabled
                          value={
                            propertyDetails && propertyDetails.NumberOfKitchen
                          }
                        />
                        <div
                          className="right-plus-button pmbutton"
            ...
            <div className="col-md-6">
              <div className="form_field st-2 label_top">
                <label htmlFor="">
                  {" "}
                  Additional Rooms - ( {
                    propertyDetails.AdditionalRooms.length
                  }{" "}
                  )
                </label>
                <div className="radio_group">
          ...
          <div className="col-md-4">
            <div className="form_field st-2 label_top">
              ...
              <div>
                {propertyDetails.Category === "Plot" ? (
                  <div className="field_error">Please enter Area & Unit</div>
                ) : propertyDetails.Category === "Residential" &&
                  ((propertyDetails.SuperArea === "" &&
                    propertyDetails.CarpetArea === "") ||
                    propertyDetails.SuperAreaUnit === "") ? (
                  <div className="field_error">
                    Please enter Super or Carpet Area & Unit{" "}
                  </div>
                ) : (propertyDetails.Category === "Residential" ||
                    propertyDetails.Category === "Commercial") &&
                  propertyDetails.SuperArea !== "" &&
                  propertyDetails.CarpetArea !== "" &&
                  Number(propertyDetails.SuperArea) <=
                    Number(propertyDetails.CarpetArea) ? (
                  <div className="field_error">
                    Super Area should be greater than Carpet Area{" "}
                  </div>
                ) : propertyDetails.Category === "Commercial" &&
                  (propertyDetails.CarpetArea === "" ||
                    propertyDetails.SuperAreaUnit === "") ? (
                  <div className="field_error">
                    Carpet Area & Unit is mandatory
                  </div>
                ) : (
                  ""
                )}
                  ...
                  <div className="plus_minus_input_wrapper">
                    ...
                    <div className="plus_minus_input">
                      ...
                      <input
                        ...
                        type="number"
                        disabled
                        onChange={addFloorNumber(
                          propertyDetails && propertyDetails.NumberOfFloors
                        )}
                        value={
                          propertyDetails && propertyDetails.NumberOfFloors
                        }
          ...
          {propertyDetails && propertyDetails.Category !== "Plot" && (
            <div className="col-md-4">
              <div className="form_field st-2 label_top">
                {propertyDetails.Category === "Residential" ? (
                  <label htmlFor="">Is Car Parking Available? </label>
                ) : (
                  <label htmlFor="">Is Private Car Parking Available? </label>
                )}
                <div className="form_field_inner">
                  <div className="form_field_container">
                    <div className="radio_group">
          ...
          {propertyDetails &&
            (propertyDetails.Category === "Residential" ||
              propertyDetails.Category === "Commercial") &&
            propertyDetails.IsCarParkingAvailable.toLowerCase() === "yes" &&
            propertyDetails.PropertyType !== "Land" &&
            propertyDetails.PropertyType !== "Other" && (
              <div className="col-md-4">
                <div className="form_field label_top">
                  ...
                  <div className="plus_minus_input_wrapper">
                    {propertyDetails.Category === "Residential" ? (
                      ...
                      <span className="pmi_label">#Count</span>
                    )}
                    <div className="plus_minus_input">
                      <div
                        className="left-minus-button pmbutton"
          ...
          {propertyDetails && propertyDetails.Category === "Plot" && (
            <div className="col-md-4">
              <div className="form_field st-2 label_top">
                ...
                {propertyDetails.IsCornerSidePlot === "" ? (
                  <div className="field_error">Is this corner side plot? </div>
                ) : (
                  ""
                )}
              </div>
          ...
          {propertyDetails && propertyDetails.Category === "Plot" && (
            <div className="col-md-4">
              <div className="form_field st-2 label_top">
                ...
                {propertyDetails.IsParkFacingPlot === "" ? (
                  <div className="field_error">Is this park facing plot? </div>
                ) : (
                  ""
                )}
              </div>
            ...
            <div className="col-md-4">
              <div className="form_field st-2 label_top">
                {propertyDetails.Category === "Residential" ? (
                  ...
                  <label htmlFor=""> Gated Complex? </label>
                )}
                <div className="form_field_inner">
                  <div className="form_field_container">
                    <div className="radio_group">
                ...
                {propertyDetails.GatedArea === "" ? (
                  <div className="field_error">Is this gated complex? </div>
                ) : (
                  ""
                )}
              </div>
