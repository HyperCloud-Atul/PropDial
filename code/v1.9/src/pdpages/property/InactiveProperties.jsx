                ...
                <div className="project-filter">
                  <nav>
                    <Link to="/allproperties/all">
                      <button className="pointer "> All ({counts.totalCount})</button>
                    </Link>
                    <Link to="/filtered-property?filter=inreview">
                      <button className="pointer ">Only In-Review ({counts.inReviewCount})</button>
                    </Link>
                    <Link to="/filtered-property?filter=inactive">
                      <button className="pointer active">Only Inactive ({counts.inactiveCount})</button>
                    </Link>
                  </nav>
                </div>
              </div>
