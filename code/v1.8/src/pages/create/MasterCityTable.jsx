...
const MasterCityTable = ({ filterData, handleEditCard }) => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value, row }) => (
          <div
            onClick={() =>
              handleEditCard(row.original.id, row.original.country, row.original.state, row.original.city,
...
export default MasterCityTable;
