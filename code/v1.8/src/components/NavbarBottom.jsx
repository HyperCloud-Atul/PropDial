...
export default function NavbarBottom() {
  ...
  const moreActiveClass = `b_menu_single ${
    shouldMoreActive ? "b_menu_active" : ""
  }`;
  // more acitve class Array

  // hide page_footer array
  const pageBottomMenuHidePaths = ["/newproperty"];
  const shouldPageFooerHide = pageBottomMenuHidePaths.includes(
    location.pathname
  );
  const pageBottomMenuClass = `${
    shouldPageFooerHide ? "page_footer_hide" : ""
  }`;
  // hide page_footer array
  return (
    <div className={`${isInspectionReportPage ? "hide_navbar" : ""}`}>
      <div className={pageBottomMenuClass}>
        <section className="bottom_menu_bar">
          ...
          <div className={moreActiveClass} onClick={showFourthPage}>
            <div className="menu_icon">
