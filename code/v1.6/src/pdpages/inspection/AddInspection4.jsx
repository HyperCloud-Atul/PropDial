...
const AddInspection = () => {
  ...
  const handleImageUpload = (index, files) => {
    ...
    if (currentImages.length + newFiles.length > 10) {
      alert("You can upload a maximum of 10 images per inspection.");
      return;
    }
                          ...
                          <div className="col-md-3">
                            ...
                            >
                              ...
                              <textarea
                                ...
                                value={inspection.generalRemark}
                                onChange={(e) =>
                                  handleInspectionChange(
                                    index,
                                    "generalRemark",
                        ...
                        {inspectionType === "Regular" && (
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              >
                                Upload Image <span style={{
                                  fontSize:"13px",
                                  fontWeight:"400"
                                }}>
                                (Max 10 image you can upload for this room)
                                </span>
                              </h6>
                              <div
                                style={{
