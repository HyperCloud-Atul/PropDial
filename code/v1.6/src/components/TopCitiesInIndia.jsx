      ...
      <section className="top_cities sect_padding">
        <div className="first_div">
          ...
          <div className="cities_single down">
            <img src="./assets/img/home/city_3.jpeg" alt="propdial" className="city_image" />
        ...
        <div className="second_div">
          <div className="first_row">
            <div className="cities_single first_row_img pointer">
              <img
                src="./assets/img/home/city_7.jpg"
                alt="propdial"
            ...
            <div className="cities_single first_row_img pointer">
              <img
                src="./assets/img/home/city_6.jpg"
                alt="propdial"
                className="city_image"
              />
            ...
            <div className="cities_single first_row_img pointer">
              <img
                src="./assets/img/home/city_8.jpg"
                alt="propdial"
                className="city_image"
              />
          ...
          <div className="second_row">
            <div className="cities_single sr_img_1 pointer">
              <img
                src="./assets/img/home/city_5.jpg"
                alt="propdial"
                className="city_image"
              />
            ...
            <div className="cities_single sr_img_2 pointer">
              <img
                src="./assets/img/home/city_2.jpg"
                alt="propdial"
                className="city_image"
              />
