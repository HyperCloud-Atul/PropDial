            ...
            <div className="container">
              ...
              >
                <div className="lep_single">
                  <div>
                    <div className="icon_div ">
                      <img src="./assets/img/home/location_f_cpg.png"></img>
                    </div>
                    <h4>Address</h4>
                  </div>
                ...
                <div className="lep_single">
                  <div>
                    <div className="icon_div">
                      <img src="./assets/img/home/emailcpg.png"></img>
                    </div>
                    <h4>Email</h4>
                  </div>
                ...
                <div className="lep_single">
                  <div>
                    <div className="icon_div">
                      <img src="./assets/img/home/callcpg.png"></img>
                    </div>
                    <h4>Phone</h4>
                  </div>
                  <h6>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-4 col-sm-12">
                ...
                <div className="footer_social_icon">
                  ...
                  >
                    <img src="./assets/img/home/facebook_footer.png" alt="" />
                  </Link>
                  <Link
                    className="fsi_single"
                    to="https://www.youtube.com/channel/UC9cJZCtePKupvCVhRoimjlg"
                  >
                    <img src="./assets/img/home/youtube_footer.png" alt="" />
                  </Link>
                  <Link
                    className="fsi_single"
                    to="https://www.linkedin.com/company/propdial-india-pvt-ltd-/"
                  >
                    <img src="./assets/img/home/linkedin_footer.png" alt="" />
                  </Link>
                  <Link
                    className="fsi_single"
                    to="https://twitter.com/i/flow/login?redirect_after_login=%2Fpropdial"
                  >
                    <img src="./assets/img/home/twitter_footer.png" alt="" />
                  </Link>
                </div>
              </div>
            </div>
